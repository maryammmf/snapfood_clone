...
<div class="col-lg-12 grid-margin stretch-card m">
    <div class="card">
        <div class="card-body" style="margin-right: 350px; margin-top: 100px">
            <h4 class="card-title ">نمایش تمام نظرات </h4>
            <div class="table-responsive">
                <div class="bg-inverse-icon-light">
                    <h4>سرچ نظر بر اساس اسم غذا</h4>
                    <form action="{{ route('comment.search') }}" method="get">
{{--                        @csrf--}}
                        <input type="text" name="name" placeholder="اسم غذا">
