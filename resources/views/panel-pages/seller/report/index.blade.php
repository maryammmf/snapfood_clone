                                ...
                                <div class="card-body px-3 py-4">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="color-card">
                                            <p class="mb-0 color-card-head">تعداد سفارش ها</p>
                                            <h2 class="text-white"> {{$orderCount}} </h2>
                                        </div>
                                        <i class="card-icon-indicator mdi mdi-cube-outline bg-inverse-icon-danger"></i>
                                    </div>
                                    <h6 class="text-white"> کل سفارش های ارسال شده </h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3 pb-lg-0 pb-xl-3">
                            <div class="card bg-primary">
                                <div class="card-body px-3 py-4">
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="color-card">
                                            <p class="mb-0 color-card-head">مبلغ فروش</p>
                                            <h2 class="text-white">{{number_format($orderPrice)}}<span style="font-size: small">  تومان </span> </h2>
                                        </div>
                                        <i class="card-icon-indicator mdi mdi-briefcase-outline bg-inverse-icon-primary"></i>
                                    </div>
                                    <h6 class="text-white">مبلغ کل فروش</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="container mt-3">
                                <div class="row">
                                    <div class="col-auto">
                                        <form action="{{ route('report.weekReport') }}">
                                            <input type="submit" class="btn btn-primary" value="گزارش این هفته">
                                        </form>
                                    </div>
                                    <div class="col-auto">
                                        <form action="{{ route('report.monthReport') }}">
                            ...
                            <div class="row">
                                <div class="card-body px-0 overflow-auto">
                                    <h4 class="card-title pl-4">کل سفارش های انجام شده</h4>

                                    @if($orders->isEmpty())
                                        <p class="bg-inverse-icon-warning text-white p-2">سفارش ارسال شده نداریم فعلا </p>
                                    @else
